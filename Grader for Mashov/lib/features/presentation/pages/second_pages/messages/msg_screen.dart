...
import 'package:grader_for_mashov_new/utilities/phone/download_utilities.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        floatingActionButton: msg == null
            ? const SizedBox()
            : msg!.attachments.isEmpty
                ? const SizedBox()
                : FloatingActionButton(
                    child: const Icon(Icons.attachment),
                    backgroundColor: const Color(0xFFffac52)
                  ...
                  Flexible(
                    ...
                    child: PopUpInformation(
                      ...
                      informationChild: Container(
                        ...
                        padding: const EdgeInsets.all(8.0),
                        child: Center(
                          child: Text(attachment[index].name!),
                        ),
                      ),
                    ),
                  ),
